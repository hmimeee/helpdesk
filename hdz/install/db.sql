...
DROP TABLE IF EXISTS `hd_articles`;
...
DROP TABLE IF EXISTS `hd_attachments`;
...
DROP TABLE IF EXISTS `hd_canned_response`;
CREATE TABLE `hd_canned_response` (
  `id` int NOT NULL,
...
DROP TABLE IF EXISTS `hd_custom_fields`;
CREATE TABLE `hd_custom_fields` (
  `id` int NOT NULL,
...
DROP TABLE IF EXISTS `hd_emails`;
CREATE TABLE `hd_emails` (
  `id` int NOT NULL,
...
DROP TABLE IF EXISTS `hd_emails_tpl`;
CREATE TABLE `hd_emails_tpl` (
...
DROP TABLE IF EXISTS `hd_kb_category`;
CREATE TABLE `hd_kb_category` (
  `id` int NOT NULL,
  `name` varchar(200) NOT NULL,
...
DROP TABLE IF EXISTS `hd_login_attempt`;
CREATE TABLE `hd_login_attempt` (
  `ip` varchar(200) NOT NULL,
  `attempts` int NOT NULL DEFAULT '0',
  `date` int NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `hd_login_log`;
CREATE TABLE `hd_login_log` (
  `id` int NOT NULL,
  `date` int NOT NULL,
  `staff_id` int NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hd_priority`;
...
DROP TABLE IF EXISTS `hd_tickets_messages`;
CREATE TABLE `hd_tickets_messages` (
  `id` int NOT NULL,
  `ticket_id` int NOT NULL DEFAULT '0',
  `date` int NOT NULL DEFAULT '0',
...
ALTER TABLE `hd_canned_response`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `hd_config`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `hd_custom_fields`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `hd_departments`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `hd_emails`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `hd_emails_tpl`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `hd_kb_category`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `hd_login_attempt`
  ADD UNIQUE KEY `ip` (`ip`);

ALTER TABLE `hd_login_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `staff_id` (`staff_id`);

ALTER TABLE `hd_priority`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `hd_tickets_messages`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ticket_id` (`ticket_id`);
...
INSERT INTO `hd_config` (`id`, `logo`, `site_name`, `windows_title`, `page_size`, `date_format`, `timezone`, `recaptcha`, `recaptcha_sitekey`, `recaptcha_privatekey`, `login_attempt`, `login_attempt_minutes`, `reply_order`, `tickets_page`, `tickets_replies`, `overdue_time`, `ticket_autoclose`, `ticket_attachment`, `ticket_attachment_number`, `ticket_file_size`, `ticket_file_type`, `kb_articles`, `kb_maxchar`, `kb_popular`, `kb_latest`) VALUES
...
INSERT INTO `hd_departments` (`id`, `dep_order`, `name`, `private`) VALUES
(1, 1, 'General', 0),
(2, 2, 'Advertising', 0),
(3, 3, 'Sales', 0);
INSERT INTO `hd_emails_tpl` (`id`, `position`, `name`, `subject`, `message`, `last_update`, `status`) VALUES
...
INSERT INTO `hd_priority` (`id`, `name`, `color`) VALUES
(1, 'Low', '#8A8A8A'),
(2, 'Medium', '#000000'),
(3, 'High', '#F07D18'),
(4, 'Urgent', '#E826C6'),
